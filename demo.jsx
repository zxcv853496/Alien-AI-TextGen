  ...
  zh: {
    ...
    pricing: {
      ...
      free: {
        ...
        price: '$0',
        unit: '/ 月',
        features: ['每月 5 分鐘額度', '匯出 SRT 字幕檔', '支援單一語言生成'],
      },
      pro: {
        title: '創作者版',
        price: '$499',
        unit: '/ 月',
        features: ['每月 60 分鐘額度', 'AI 多國語言翻譯', '雙語字幕輸出'],
        badge: '最熱門',
      },
      studio: {
        title: '企業版',
        price: '$1,299',
        unit: '/ 月',
        features: ['每月 200 分鐘額度', '優先極速渲染', '專屬詞彙庫微調'],
      },
      btn_try: '註冊試用',
      btn_upgrade: '立即升級',
      btn_contact: '聯繫業務',
  ...
  en: {
    ...
    pricing: {
      ...
      free: {
        ...
        price: '$0',
        unit: '/ mo',
        features: ['5 mins credit / month', 'Export SRT files', 'Single language generation'],
      },
      pro: {
        title: 'Creator',
        price: '$499',
        unit: '/ mo',
        features: ['60 mins credit / month', 'AI Multi-language Translation', 'Bilingual Output'],
        badge: 'Popular',
      },
      studio: {
        title: 'Enterprise',
        price: '$1,299',
        unit: '/ mo',
        features: ['200 mins credit / month', 'Priority Rendering', 'Custom Vocabulary'],
      },
      btn_try: 'Try Now',
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-8 rounded-2xl border border-slate-200 hover:border-indigo-300 transition-all">
            ...
            <div className="text-3xl font-bold text-slate-900 mb-6">
              ...
              <span className="text-base font-normal text-slate-500">{t.pricing.free.unit}</span>
            </div>
            <ul className="space-y-4 mb-8 text-sm text-slate-600">
              {t.pricing.free.features.map((item, i) => (
                <li key={i} className="flex gap-2">
                  <CheckCircle className="w-4 h-4 text-slate-400" /> {item}
                </li>
              ))}
            </ul>
            <button
          ...
          <div className="bg-white p-8 rounded-2xl border-2 border-indigo-600 relative shadow-xl shadow-indigo-100">
            ...
            <div className="text-3xl font-bold text-slate-900 mb-6">
              {t.pricing.pro.price}{' '}
              <span className="text-base font-normal text-slate-500">{t.pricing.pro.unit}</span>
            </div>
            <ul className="space-y-4 mb-8 text-sm text-slate-600">
          ...
          <div className="bg-white p-8 rounded-2xl border border-slate-200 hover:border-indigo-300 transition-all">
            ...
            <div className="text-3xl font-bold text-slate-900 mb-6">
              ...
              <span className="text-base font-normal text-slate-500">{t.pricing.studio.unit}</span>
            </div>
            <ul className="space-y-4 mb-8 text-sm text-slate-600">
              ...
              <div className="mt-8">
                <div className="flex justify-between items-center text-sm mb-4">
                  ...
                  <span className="font-bold text-slate-800">
                    {targetLang ? '80' : '50'} {translations.zh.nav.credits}
                  </span>
                </div>
                <button
      ...
      {step === 'processing' && (
        <div className="max-w-2xl mx-auto bg-white rounded-2xl shadow-lg border border-slate-100 p-12 text-center">
          ...
          <div className="flex justify-between text-xs text-slate-400 font-medium">
            {t.editor.processing.steps.map((s, i) => (
              <span key={i}>{s}</span>
            ))}
          </div>
        </div>
      ...
      <header className="bg-white/80 backdrop-blur-md border-b border-slate-200 px-6 py-4 flex justify-between items-center sticky top-0 z-50">
        ...
        >
          ...
          <span className="text-xl font-bold tracking-tight text-slate-800">
            Alien AI{' '}
            <span className="text-xs font-normal text-slate-500 ml-1">Translate Studio</span>
          </span>
        </div>
